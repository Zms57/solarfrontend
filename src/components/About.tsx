  ...
  return (
    <>
      ...
      <motion.section id="about" className={styles.about} initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1.2}}>
        ...
        {[
    { image: 'member1.jpg', name: 'Wing Hei Tsang', position: 'Solar Energy Specialist' },
    { image: 'member2.jpg', name: 'Yesica Nithiyanantha', position: 'Solar Energy Specialist' },
    { image: 'member3.jpg', name: 'Ava Natali Ghahramanyan', position: 'Solar Energy Specialist' },
    { image: 'member4.jpg', name: 'Maira Asif', position: 'Solar Energy Specialist' },
    { image: 'member5.jpg', name: 'Zainab Alsaffar', position: 'Solar Energy Specialist' },
  ].map((member, index) => (
